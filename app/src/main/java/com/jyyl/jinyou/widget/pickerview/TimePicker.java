package com.jyyl.jinyou.widget.pickerview;
...
import com.jyyl.jinyou.widget.wheelview.OnWheelChangedListener;
import com.jyyl.jinyou.widget.wheelview.WheelView;
...
public class TimePicker extends LinearLayout{
    ...
    private void init(Context context){
        ...
        //小时选择器
        hours = (WheelView) findViewById(R.id.time_hour);
        ...
        //分钟选择器
        mins = (WheelView) findViewById(R.id.time_min);

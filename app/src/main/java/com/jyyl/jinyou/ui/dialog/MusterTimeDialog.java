...
import com.jyyl.jinyou.widget.pickerview.TimePicker;
 ...
 */
public class MusterTimeDialog extends DialogFragment {
    ...
    //向activity传递数据的接口
    public interface MusterTimeListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_muster_time, null);
        ...
        builder.setView(view)
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        MusterTimeListener listener = (MusterTimeListener) getActivity();
